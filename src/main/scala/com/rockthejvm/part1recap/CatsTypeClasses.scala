...
object CatsTypeClasses {
  ...
  // functor - data type that is "mappable"
  trait MyFunctor[F[_]] {
  ...
  // flatMap - ability to chain multiple com
  ...
  */
  ...
  val desireableValue: ErrorOr[Int] = appErrorEither.pure(42)
  ...
  val listOfOptions: List[Option[Int]] = List(Some(1), Some(2), Some(99))
